...
function create_gke() {
    gcloud beta container \
        --project "gwc-sandbox" clusters create "elk" \
        --region "us-central1" \
        --no-enable-basic-auth --cluster-version "1.20.8-gke.900" \
        --release-channel "regular" --machine-type "n2-standard-8" \
        ...
        --enable-ip-alias \
        --network "projects/gwc-sandbox/global/networks/default" \
        --subnetwork "projects/gwc-sandbox/regions/us-central1/subnetworks/default" \
        ...
        --workload-pool "gwc-sandbox.svc.id.goog" --enable-shielded-nodes --shielded-secure-boot
}
